...
Original file is located at
    https://colab.research.google.com/drive/11T093J3lyibnw1WeQmV2Zp_3lnDsL2hk
"""
...
# #!/usr/bin/env python3
# """
# ResQRelief: Disaster Management System for Google Colab
# """
# 
# import pandas as pd
# import numpy as np
...
!pip install flask nltk scikit-learn pandas numpy joblib pyngrok
...
try:
    ...
    print(f"✅ ResQRelief is LIVE at: {public_url}")

    from IPython.display import HTML, display
    display(HTML(f'''
    <div style="padding: 20px; background: #27ae60; border-radius: 10px; text-align: center;">
        <h2 style="color: white;">🛡️ ResQRelief is Ready!</h2>
        <a href="{public_url}" target="_blank"
           style="background: white; color: #27ae60; padding: 15px 30px;
    ...
    print(f"App running locally at: http://localhost:5000")
    print("For public access, get ngrok token from https://ngrok.com")

!ngrok config add-authtoken 32g1RTiSaYZOs5oTdkpxQpzuH9F_BE4GvM9Ettwyq95NYgWt